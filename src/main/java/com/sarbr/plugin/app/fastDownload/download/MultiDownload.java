...
import com.sarbr.plugin.app.fastDownload.extractor.FileProgressExtractor;
...
public class MultiDownload implements Download {
    private final int threadNum;
    private RestTemplate restTemplate;

    public MultiDownload(int threadNum) {
    ...
    @Override
    public void doDownload(String fileURL, String dir, String fileName, HttpHeaders headers) throws IOException {
        ...
        for (int index = 0; index < threadNum; index++) {
            ...
            FileProgressExtractor extractor = new FileProgressExtractor(tempFilePath);
            ...
            CompletableFuture<File> future = CompletableFuture.supplyAsync(() -> {
                ...
                return getRestTemplate().execute(fileURL, HttpMethod.GET, callback, extractor);
